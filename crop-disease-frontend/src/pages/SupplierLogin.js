...
setSupplierToken(response.data.access_token); // 🔥 update state
navigate("/supplier-dashboard");
  ...
  const handleRegister = async () => {
    if (!name || !email || !phone || !city || !area || !password) {
    ...
    try {
      await API.post("/suppliers/register", {
        name: name.trim(),
        email: email.trim(),
        phone: phone.trim(),
        city: city.trim(),
      ...
      <div className="auth-layout">
        ...
        >
          ...
          <p className="left-description">
            Manage your medicines, connect with farmers, and grow your agri-business.
          </p>
        </motion.div>
